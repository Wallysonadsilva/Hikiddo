...
Future<BitmapDescriptor> getMarkerIcon1(String assetPath, Size size) async {
  ...
  ui.Codec codec = await ui.instantiateImageCodec(imgBytes,
      ...
      targetHeight:
          size.height.toInt()); // Ensure the image fits your size requirements
...
// Oval for the image
  Rect oval = Rect.fromLTWH(
      ...
      15.0 + 3.0, // shadowWidth + borderWidth
      size.width -
          ((15.0 + 3.0) * 2), // size.width - (shadowWidth + borderWidth) * 2
      size.height -
          ((15.0 + 3.0) * 2)); // size.height - (shadowWidth + borderWidth) * 2
...
Future<BitmapDescriptor> getMarkerIconFromUrl1(
    String imageUrl, Size size) async {
  try {
